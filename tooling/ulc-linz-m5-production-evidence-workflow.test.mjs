...
test("M5-F retention runner fails closed for every privilege-escalation class", async () => {
  const overprivileged = [
    ...
    { reverse_membership_count: 1 }, { cleanup_group_membership_count: 1 }, { cleanup_group_member_count: 2 },
    { cleanup_group_admin_member_count: 1 }, { cleanup_execute: false }, { direct_select: true },
    { direct_delete: true }, { direct_insert: true }, { direct_update: true }, { direct_truncate: true },
    { direct_trigger: true }, { direct_references: true }, { retention_read: false },
    { forbidden_column_select: true }, { forbidden_column_mutation: true }, { sequence_usage: true },
    { sequence_select: true }, { sequence_update: true }, { protected_object_owner_count: 1 },
