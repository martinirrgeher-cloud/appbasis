...
const retiredWorkflowUrl = new URL("../.github/workflows/m5-ulc-production-evidence.yml", import.meta.url);
...
test("legacy operational M5 production evidence workflow is retired", async () => {
  await assert.rejects(
    () => readFile(retiredWorkflowUrl, "utf8"),
