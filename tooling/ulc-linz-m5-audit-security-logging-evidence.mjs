...
const CONTROLLED_RETENTION_CONTRACT_FIELDS = Object.freeze([
  "source", "providerMinimumRetentionVerified", "cutoffSemantics",
  "serverRetentionBoundaryVerified", "leastPrivilegeCleanupVerified",
  "clientCutoffOverridePresent", "enforcementContractDigest",
]);
const CONTRACT_FILES = Object.freeze([
  ...
  ["apps/ulc-linz/worker/security-events-postgres.ts", new URL("../apps/ulc-linz/worker/security-events-postgres.ts", import.meta.url), "b1deaf9ea5c725835f6b0418ed9646b753850f1c"],
  ...
  ["apps/ulc-linz/migrations/0003_ulc_linz_security_event_access.sql", new URL("../apps/ulc-linz/migrations/0003_ulc_linz_security_event_access.sql", import.meta.url), "1d1ef22e037fedbe8aa3206ce931e44a9ea2c672"],
]);
...
function retentionVerified(mode, evidence, nowDate) {
  ...
  if (mode === "controlled-calendar-contract") {
    ...
    return (
      ...
      value.providerMinimumRetentionVerified === true &&
      value.cutoffSemantics === "occurred-at-strictly-older-than-12-calendar-months" &&
      value.serverRetentionBoundaryVerified === true &&
