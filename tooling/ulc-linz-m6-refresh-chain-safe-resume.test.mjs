...
test("M6 refresh chain reuses prerequisites only across a bounded evidence-only ancestry", async () => {
  ...
  for (const marker of [
    ...
    '.files | type == "array" and length >= 1 and length <= 20',
    ...
    "tooling/ulc-linz-m5-production-g-evidence.mjs",
    "tooling/ulc-linz-m5-production-g-evidence.test.mjs",
    "tooling/ulc-linz-m5-production-f-evidence.mjs",
    "tooling/ulc-linz-m5-production-f-evidence.test.mjs",
